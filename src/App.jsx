...
function App() {
  ...
  return (
    <div className="bg-slate-700 text-slate-100 pt-20 min-h-screen">
      <div className="max-w-xl mx-auto border border-slate-600 rounded p-10">
        <h1 className="text-center text-3xl mb-2">Pomodoro App</h1>
        <p className="text-center text-xm mb-8 text-slate-400">Set your concentration and break time.</p>
        ...
        <div className="flex justify-center mb-8">
          ...
          <div className="mr-10">
            ...
            <div className="flex">
              ...
              <p className="mx-5 text-xl">{chronoValues.session.value / 60} </p>
              <UpdateTimeButton sign={"+"} type={"session"} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              ...
              <p className="mx-5 text-xl">{chronoValues.pause.value  / 60}</p>
              <UpdateTimeButton sign={"+"} type={"pause"} />
        ...
        <p className="text-center flex justify-center mb-1">
          <span className="text-4xl py-2 px-24 rounded bg-slate-300 text-slate-900">{getFormatedValue(chronoValues.displayedValue.value)}</span>
        </p>
